...
# ---------------------------------------
# SOURCE:  https://raw.githubusercontent.com/PacktPublishing/TensorFlow-Machine-Learning-Cookbook/master/Chapter%2007/text_helpers.py
...
def load_movie_data(data_folder_name, save_folder_name='RawData'):
